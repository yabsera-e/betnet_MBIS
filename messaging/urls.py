...
urlpatterns = [
    ...
    path('conversation-payment/<int:conversation_id>/', views.messaging_payment, name='messaging_payment'),
    #path('payment/<int:conversation_id>/', views.messaging_payment, name='messaging_payment'),  # added
]
